...
const getRedisClient =() => redisClient;// this function returns the redisClient instance, allowing other parts of the application to use it for caching and retrieving data from Redis
